...
import (
	...
	configuration "github.com/buildbarn/bb-remote-execution/pkg/configuration/bb_worker"
...
func main() {
	...
	botClient := remoteworker.NewBotClient(botConnection)
